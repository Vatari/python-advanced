...
def render_products():
    ...
    with open("db/products.txt", "r") as file:
        ...
        for line in products:
            ...
            Label(app, text=product["name"]).grid(row=row + 1, column=col, pady=2)
            ...
            Label(app, text=product["count"]).grid(row=row + 3, column=col, pady=2)
            button = Button(app, text=f"Buy {product['id']}")
